...
public class FileManager {
    ...
    public void createFile(User user, String name, String extension, String content) {
        ...
        if (current.getChild(name) != null) throw new RuntimeException("Archivo ya existe");
    ...
    public void createDirectory(User user, String name) {
        ...
        DirectoryNode current = user.getCurrentDirectory();
        if (current.getChild(name) != null) throw new RuntimeException("Directorio ya existe");
    ...
    public void changeDirectory(User user, String name) {
        ...
        else throw new RuntimeException("Directorio no encontrado");
    }
    ...
    public String viewFile(User user, String name) {
        ...
        if (n instanceof FileNode file) return file.getContent();
    ...
    public void modifyFile(User user, String name, String newContent) {
        // Modificar archivo
        Node n = user.getCurrentDirectory().getChild(name);
        if (n instanceof FileNode file) file.setContent(newContent);
        else throw new RuntimeException("No es un archivo");
    }
